...
Page({
    data: {
        ...
        time_slot: [], // 时间段
        hear_trate: [],
        max_hear_trate: 0, // 睡眠最大值
	    min_hear_trate: 0, // 睡眠最小值
	    // heart_rate_range: "50-148", // 睡眠范围
	    resting_heart_rate: 0, // 睡眠
    },
    ...
    getHeartRateLineChart(){
        ...
        request.request_get('/manage/getHeartRateLineChart.hn', data, function (res) {
            if (res) {
                if (!res.success) {
                ...
                that.setData({
                    ...
                    hear_trate: res.hear_trate,
                    max_hear_trate: res.max_hear_trate,
                    min_hear_trate: res.min_hear_trate,
                    // heart_rate_range: res.msg.heart_rate_range,
                    resting_heart_rate: res.resting_heart_rate
                });
